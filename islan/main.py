...
def main():
    ...
    ismapper_parser = subparsers.add_parser("is-mapping", help="Identify IS insertion sites from targeted IS-Seq data")
    ...
    ismapper_parser.add_argument("--head", help="HEAD primer extracted reads")
    ismapper_parser.add_argument("--tail", help="TAIL primer extracted reads")
    ismapper_parser.add_argument("--filtered_forward", help="Filtered forward reads _1.fastq.gz")
    ismapper_parser.add_argument("--filtered_reverse", help="Filtered reverse reads _2.fastq.gz")
    ...
    ismapper_parser.add_argument("--is_name", default=None, help="IS element name to filter known positions (e.g. ISKpn26). If not set, all IS elements are used.")
